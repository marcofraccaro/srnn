"""
Implementation of the Stochastic RNN (SRNN) for polyphonic music modelling.
"""
from __future__ import print_function, division
import time, datetime
from ml.data.timit_data import TimitData
from ml.models.SRNN_midi import SRNN_midi
from ml.training.train_srnn_midi import TrainSRNN_midi
...
def run(dataset='muse', nonlinearity_encoder='clipped_very_leaky_rectify',
...
class Settings_SRNN(ml.settings.Settings):
    def __init__(self, dataset='muse', nonlinearity_encoder='clipped_very_leaky_rectify',
